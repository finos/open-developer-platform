...
<img alt="odp-landscape" src={useBaseUrl('img/odp-landscape.png')} />

## ODP Vendors
The following technology vendors have been supporting the activity of ODP.

<img alt="github" src={useBaseUrl('img/vendors/github-logo.jpg')} />
<img alt="whitesource" src={useBaseUrl('img/vendors/whitesource-logo.png')} />
<img alt="red-hat" src={useBaseUrl('img/vendors/redhat-logo.svg')} />
<img alt="greenkey-tech" src={useBaseUrl('img/vendors/greenkey-tech-logo.png')} />
<img alt="fossa" src={useBaseUrl('img/vendors/fossa-logo.jpeg')} />
