...
Both features **support email notifications** and the ability to post a comment by answering to it. Simply raise a [FINOS Slack Project Channel / GitHub Team Discussions Request](https://github.com/finos/open-developer-platform/issues/new?assignees=mcleo-d&labels=comms-channel-request&template=Communication_channel_request.md&title=) to enable GitHub Team Discussions for your FINOS project team. 
...
The FINOS Community can access the FINOS Slack by visiting https://finos-lf.slack.com/ and requesting access to join.
...
All participants in the FINOS Slack Workspace are subject to the [LF Antitrust Policy](https://www.linuxfoundation.org/antitrust-policy/), the [FINOS Community Code of Conduct](https://github.com/finos/community/blob/master/governance/Code-of-Conduct.md) and all other [FINOS policies](https://github.com/finos/community/tree/master/governance#policies). 

It's extremely important that all participants in the FINOS Slack Workspace do not participate in any activities that are prohibited under applicable US state, federal or foreign antitrust and competition laws. Please contact legal@finos.org with any questions.
