...
- *At the end of the meeting* - the meeting leader closes the issue, which will trigger the attendants the indexing process
...
- Never reopen and close a meeting minutes issue, to avoid duplicative entries. If you're uncertain or want to revert changes, get in touch with FINOS staff via [help@finos.org](mailto:help@finos.org).
